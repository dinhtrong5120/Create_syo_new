...
def create_cadics_old(case, market, powertrain, car, list_group):
    ...
    # ========================Create File Output=============================
    adddress_config, frame_header, dict_grade, max_car, dict_optioncode, body_type = get_infor_car(data_spec)
    # print(frame_header)
    my_dict_data = [{i: None for i in range(1, 180)}]
...
def get_infor_car(df_spec):
    ...
    return dic_col_config, frame_header, dict_grade, count, dict_optioncode, body_type
