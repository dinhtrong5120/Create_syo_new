...
# #     form_syo = pd.read_excel(r'C:\Users\KNT21617\Documents\2_8_2024\form_syo_o_nha.xlsx', sheet_name='Sheet4')
# #     data_spec = pd.read_excel(r'C:\Users\KNT21617\Documents\2_8_2024\data_spec.xlsx')
# #     data_for_create = [data_spec, 1, 9, 6, 8, 29]
# #     df = create_syo(form_syo, data_for_create)
# #     df.to_excel(r'C:\Users\KNT21617\Documents\2_8_2024\results_o_nha.xlsx', index=False)
import re
import pandas as pd
from src.app.edit_syo_new import logic_add, process_dataframe
...
# if __name__ == '__main__':
#     form_syo = pd.read_excel(r'C:\Users\KNT21617\Documents\2_8_2024\form_syo_vip.xlsx', sheet_name='Sheet1')
#     data_spec = pd.read_excel(r'C:\Users\KNT21617\Documents\2_8_2024\data_spec.xlsx')
#     data_for_create = [data_spec, 1, 9, 6, 8, 29]
#     df = create_syo(form_syo, data_for_create)
#     df.to_excel(r'C:\Users\KNT21617\Documents\2_8_2024\results.xlsx', index=False)
