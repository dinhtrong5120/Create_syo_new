...
INSERT INTO `information_project` VALUES ('AXLE','','',''),('BODY','','',''),('CCM','XQA商品性','',''),('ENGINE','XX4PT','KH1T',''),('GRADE','','',''),('HANDLE','','',''),('INTAKE','XX4NH電動車,XX4PT','BATTERY (MIDDLE),DIESEL,FFV,HEV/E-PWR,','FFV:Flexible-fuel vehicle混合燃料車'),('NUMBER','','',''),('SEAT/EQUIP','','',''),('TRANS','XX4PT,XX4AD','CVT,7AT/9AT,DCT,ATM (for EV)',''),('YEAR','','',''),('ZONE','','','');
...
-- Dump completed on 2024-06-28  9:07:45
